...
class Raven {
  constructor() {
    ...
    this.width = (this.spritwidth / 2.5) * this.sizeModifier;
    this.height = (this.spritheight / 2.5) * this.sizeModifier;
    this.x = canvas.width;
...
window.addEventListener("click", function (e) {
  rect = collisionCanvas.getBoundingClientRect();
